...
def run_pilot(
    ...
    return {
        ...
        "explanation_completeness_rate": explanation_complete / len(rows) if rows else None,
        "metadata_insufficiency_rate": metadata_insufficient / len(rows) if rows else None,
