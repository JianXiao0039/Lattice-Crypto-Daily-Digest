...
Release status: v0.1.0 first public research automation release. See [CHANGELOG.md](CHANGELOG.md), [docs/releases/v0.1.0.md](docs/releases/v0.1.0.md), and [docs/release-checklist.md](docs/release-checklist.md).
...
本项目提供 Zotero-ready export，用于把已有 `data/*.json` 转换成稳定文献库互操作格式。导出层只读取已有 digest JSON，不运行 fetcher，也不修改 `data/`、`digests/` 或 `papers.db`。
