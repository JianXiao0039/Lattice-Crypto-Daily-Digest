...
Release status: v0.2.0-rc1 Library Interoperability Release Candidate. This is not the stable v0.2.0 release. See [CHANGELOG.md](CHANGELOG.md), [docs/releases/v0.1.0.md](docs/releases/v0.1.0.md), [docs/releases/v0.2.0-rc1.md](docs/releases/v0.2.0-rc1.md), and [docs/release-checklist.md](docs/release-checklist.md).
...
v0.2.0-rc1 提供 Stable Library Export Layer 和 Zotero-ready export，用于把已有 `data/*.json` 转换成稳定文献库互操作格式。导出层只读取已有 digest JSON，不运行 fetcher，也不修改 `data/`、`digests/` 或 `papers.db`。
...
详细说明见 [docs/library-interop.md](docs/library-interop.md)。本地导出命令：
