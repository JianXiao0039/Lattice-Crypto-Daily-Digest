...
LATTICE_RULES: list[tuple[str, tuple[str, ...]]] = [
    ...
    ("Polynomial Quotient Ring", (r"\bpolynomial quotient ring\b", r"\bpolynomial quotient rings\b", r"\bquotient ring\b", r"\bquotient rings\b")),
...
ATTACK_RULES: list[tuple[str, tuple[str, ...]]] = [
    ...
    ("Distinguisher", (r"\bdistinguisher\b", r"\bdistinguishers\b", r"\bdistinguishing\b")),
...
PRIMITIVE_RULES: list[tuple[str, tuple[str, ...]]] = [
    ...
    ("Anonymous Credential", (r"\banonymous credential\b", r"\banonymous credentials\b")),
...
AI_RULES: list[tuple[str, tuple[str, ...]]] = [
    ...
    ("Learned Distinguisher", (r"\blearned distinguisher\b", r"\blearned distinguishers\b")),
